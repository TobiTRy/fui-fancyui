  ...
  return (
    <Wrapper>
      <StyledHeading>
        ...
        {title && <Typography type='inlineElement' variant='h3'>{title}</Typography>}
      </StyledHeading>
    </Wrapper>
  )
}
