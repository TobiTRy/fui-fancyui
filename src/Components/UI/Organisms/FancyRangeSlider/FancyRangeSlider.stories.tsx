...
export default {
  title: 'Example/FancyRangeSlider',
...
} as ComponentMeta<typeof FancyRangeSlider>;



const Template: ComponentStory<typeof FancyRangeSlider> = (args) => <FancyRangeSlider {...args} />;
