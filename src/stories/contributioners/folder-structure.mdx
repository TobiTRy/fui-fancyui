...
<Meta title="contributioners/folder-structure" />

## Source Directory folder structure Documentation
...
- `globalSizes.ts`: Specifies global sizeC parameters that are consistent throughout the app.
