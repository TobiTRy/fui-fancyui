...
import FancySwitchRoute from '@/Routes/FancySwitchRoute/FancySwitchRoute';
// const Icon = (
        ...
        <FancyThemeProvider>
          ...
          <div style={{ height: '100vh' }}>
            <nav>
              <OwnUl>
                ...
                <li>
                  <Link to="/fancyswitch">FancySwitch</Link>
                </li>
                <li>
          ...
          renders the first one that matches the current URL. */}
            <Routes>
              ...
              <Route path="/fancyswitch" element={<FancySwitchRoute />} />
