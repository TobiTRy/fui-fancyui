...
const svg = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
...
function App() {
  ...
  return (
    <div className="App">
      <FancyInputV2 textColor='dark' align='left' icon={svg} type='password' label='Username'/>
    </div>
  );
}
