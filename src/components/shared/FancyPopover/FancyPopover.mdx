...
<Meta title="components/shared/FancyPopover" />
...
- `onOutsideClick`: () => void - A callback function that is called when the user clicks outside the popover to close it.
...
import FancyPopover from 'fui-fancyui';
