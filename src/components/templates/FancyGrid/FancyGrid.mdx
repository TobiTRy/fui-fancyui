...
```jsx
<FancyGrid grid={12} space="2px">
  <FancyGrid.Item gridSpace={4}>{/* Content for the first item */}</FancyGrid.Item>
  <FancyGrid.Item gridSpace={4}>{/* Content for the second item */}</FancyGrid.Item>
  <FancyGrid.Item gridSpace={4}>{/* Content for the third item */}</FancyGrid.Item>
  {/* Since the grid limit is reached, the next item starts on a new line */}
  <FancyGrid.Item gridSpace={12}>{/* Content for the fourth item */}</FancyGrid.Item>
</FancyGrid>
```
