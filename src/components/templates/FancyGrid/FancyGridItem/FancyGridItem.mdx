...
- `gridSpace`: Defines the number of columns that the item will span within the grid. It's a number indicating the fraction of the grid occupied by the item.
- `breakpoints`: (Optional) An array of custom breakpoint objects, allowing responsive adjustments at specified screen sizes.
